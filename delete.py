...
# because the costs can certainly stack up over time and put a dent in your wallet. 
# For services like SageMaker
# endpoints, you are charged by the hour, so be sure to delete them once you’re done with them.

# Ins 2
# As for the S3 bucket and the ECR container, those are a one-time charge that 
# only bill for data transfer.
